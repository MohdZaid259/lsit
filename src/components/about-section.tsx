  ...
  return (
    <>
      ...
      <section className="relative bg-primary text-white">
        ...
        <div className="container relative px-4 py-20 md:mx-16 mx-auto sm:px-6 lg:px-16">
          <div className="max-w-3xl">
            <h1 className="mb-4 text-4xl font-bold tracking-tight sm:text-5xl">
              About Our Company
            </h1>
            <p className="mb-8 text-lg text-white/80 sm:text-xl">
              Engineering fabrics that protect, perform, and endure — no matter
              the environment
            </p>
          </div>
        </div>
      ...
      <section className="bg-primary/10 py-16 md:py-24 ">
        <div className="mx-0 md:mx-24 px-4 sm:px-6 lg:px-8">
