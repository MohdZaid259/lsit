        ...
        <div className="container relative px-4 py-20  sm:px-6 lg:px-16">
          <div className="max-w-3xl">
            ...
            <p className="mb-8 text-lg text-white/80 sm:text-xl">
              Your trusted technical service provider in Dubai since 2010,
            ...
            <ScrollAnimation animation="fade-in-left">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Founded in 2010, our company has grown from a small civil
                    contracting business to a comprehensive technical service
                    provider in Dubai and across the UAE. What started as a
                    vision to deliver quality services has evolved into a
                    trusted name in the industry.
                  </p>
                  <p>
                    Over the years, we've expanded our expertise to include
                    heavy equipment lifting and transportation, birds and pest
                    control, marble supply, and all kinds of civil and carpentry
                    work. This diversification allows us to be a one-stop
                    solution for all technical service needs.
                  </p>
                  <p>
                    Today, we're proud to have served hundreds of clients across
                    residential, commercial, and industrial sectors, building a
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            <ScrollAnimation animation="fade-in-left">
              <div className="rounded-xl bg-white p-8 shadow-sm">
                ...
                <p className="text-muted-foreground">
                  ...
                  recognized for excellence, innovation, and customer
                  satisfaction. We aim to set new standards in the industry by
                  delivering comprehensive solutions that exceed client
                  expectations and contribute to the development of Dubai's
                  infrastructure.
                </p>
              </div>
            </ScrollAnimation>
            <ScrollAnimation animation="fade-in-right">
              <div className="rounded-xl bg-white p-8 shadow-sm">
                ...
                <p className="text-muted-foreground">
                  To deliver high-quality technical services that meet the
                  diverse needs of our clients through professional expertise,
                  innovative solutions, and unwavering commitment to excellence.
                  We strive to build lasting relationships with our clients by
                  providing reliable, safe, and timely services that add value
                  to their projects.
                </p>
              </div>
            </ScrollAnimation>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12 text-center">
            <ScrollAnimation animation="fade-in-up">
              <h2 className="mb-4 text-3xl font-bold text-navy-blue sm:text-4xl">
                Our Values
              </h2>
            ...
            {values.map((value, index) => (
              ...
              >
                <div className="rounded-xl border border-primary/40 p-6">
                  ...
                  <h3 className="mb-2 text-xl font-semibold text-navy-blue">
                    {value.title}
                  </h3>
